function FormatAndShowOutput(values, part) {
   switch (part) {
     ...
     case 3:
        ...
        break;
     case 4:
        document.getElementById('ConversionOutput').textContent = "Friend, " + values[0] + " and " +
        values[1] +", these two random adjectives describe you perfectly." +
        " Now, you must live with this knowledge. I am truly sorry."
        break;
     default:
